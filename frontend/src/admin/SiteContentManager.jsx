...
export default function SiteContentManager() {
  ...
  return <div className={`cms-page cms-page--${activeTab}`}>
    ...
    <style>{`
      ...
      .cms-card.is-active,.cms-page--music .cms-card:nth-of-type(7),.cms-page--faq .cms-card:nth-of-type(8),.cms-page--services .cms-card:nth-of-type(9),.cms-page--contact .cms-card:nth-of-type(10){display:block}
      ...
      @media(min-width:1000px){.cms-page[class*="cms-page--"]{grid-template-columns:230px minmax(0,1fr);align-items:start;gap:18px}.cms-page .cms-tabs{grid-column:1;grid-row:1/span 20}.cms-page .cms-card,.cms-page .cms-subtabs{grid-column:2}.cms-page .cms-card{max-height:calc(100vh - 150px);overflow:auto;scrollbar-width:thin}}
      ...
      @media(max-width:600px){.cms-page[class*="cms-page--"]{padding:14px;gap:14px}.cms-tabs{top:70px;margin-inline:-4px}.cms-tabs .cms-tabs__save{position:sticky;right:0}.cms-subtabs{overflow-x:auto}.cms-subtabs button{flex:0 0 auto;min-width:max-content}.cms-page .cms-card{padding:18px}.cms-page .cms-card h2{font-size:1.25rem}.cms-page .cms-grid{gap:12px}}
    `}</style>
